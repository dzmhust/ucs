...
public class TestGenCode {
    ...
    private static final String packagePath = "com.dzmsoft.ucs.ccs";
    //生成js和jsp文件时的文件夹名
    private static final String modulePath = "ccs";
    ...
    public void genCommon(){
        ...
        VmParams vmParams = new VmParams.Builder()
            ...
            .addBeanName(CcsDataDictType.class.getName())
            .addBeanName(CcsTemplate.class.getName())
            .addBeanName(CcsDataDictionary.class.getName())
            .addBeanName(CcsDataDictionaryTree.class.getName())
